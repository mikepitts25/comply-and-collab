// Shared POA&M export shaping — eMASS POA&M workbook column order, consumed by
// both the CSV and XLSX exporters so they never drift apart.
import type {
  Poam,
  System,
  User,
...
export function poamRow(p: PoamForExport): string[] {
